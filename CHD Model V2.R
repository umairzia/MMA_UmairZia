...
# currentSmoker and Hypertension stay
...
Logmodel_v1 = glm(TenYearCHD ~ . -sysBP -diaBP -prevalentHyp -education -heartRate -currentSmoker
                  -BPMeds_prevalentHyp -prevalentHyp_age -male_BMI -diabetes_BMI
                  -cigsperday_heartrate -sysBP_age -prevalentHyp_diaBP
                  -prevalentHyp_age -sysBP_diaBP -age_CHD -BPMeds_diaBP -BPMeds_sysBP, data=train, family=binomial)
summary(Logmodel_v1)
